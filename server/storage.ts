import { type Question, type Animal, type QuizResult, type InsertQuestion, type InsertAnimal, type InsertQuizResult, type QuizOption } from "@shared/schema";
    ...
    const questionsData: Omit<Question, 'id'>[] = [
      {
        ...
        options: [
          { text: "Take charge and lead conversations", traits: { leadership: 3, confidence: 3, social: 2 } },
          { text: "Naturally participate and enjoy the company", traits: { social: 3, adaptability: 2, empathy: 2 } },
          { text: "Listen carefully and contribute thoughtfully", traits: { wisdom: 3, empathy: 2, introversion: 2 } },
          { text: "Prefer to observe from the sidelines", traits: { introversion: 3, independence: 2, caution: 2 } }
        ],
        order: 1
      },
      {
        ...
        options: [
          { text: "Jump right in and figure it out as you go", traits: { adventure: 3, confidence: 2, impulsiveness: 2 } },
          { text: "Carefully plan your approach step by step", traits: { wisdom: 3, caution: 2, strategy: 3 } },
          { text: "Seek advice from others before proceeding", traits: { collaboration: 3, empathy: 2, humility: 2 } },
          { text: "Consider all possible risks first", traits: { caution: 3, wisdom: 2, introversion: 1 } }
        ],
        order: 2
      },
      {
        ...
        options: [
          { text: "Leading an outdoor adventure with friends", traits: { leadership: 2, adventure: 3, social: 2 } },
          { text: "Exploring a new place or trying new activities", traits: { adventure: 3, curiosity: 3, adaptability: 2 } },
          { text: "Reading a good book or learning something new", traits: { wisdom: 3, introversion: 2, curiosity: 2 } },
          { text: "Relaxing at home in your own space", traits: { introversion: 3, independence: 2, comfort: 2 } }
        ],
        order: 3
      },
      {
        ...
        options: [
          { text: "Take the lead and delegate tasks", traits: { leadership: 3, confidence: 2, strategy: 2 } },
          { text: "Bring creative ideas and keep everyone motivated", traits: { creativity: 3, social: 2, optimism: 2 } },
          { text: "Provide thoughtful analysis and solutions", traits: { wisdom: 3, strategy: 2, introversion: 1 } },
          { text: "Work independently on your assigned part", traits: { independence: 3, introversion: 2, focus: 2 } }
        ],
        order: 4
      },
      {
        ...
        options: [
          { text: "Face it head-on with determination", traits: { confidence: 3, leadership: 2, strength: 2 } },
          { text: "Stay flexible and adapt to the situation", traits: { adaptability: 3, optimism: 2, resilience: 2 } },
          { text: "Think through the problem systematically", traits: { wisdom: 3, strategy: 2, patience: 2 } },
          { text: "Take time alone to process and recharge", traits: { introversion: 3, self_care: 2, reflection: 2 } }
        ],
        order: 5
      },
      {
        ...
        options: [
          { text: "Trust your instincts and decide quickly", traits: { confidence: 3, impulsiveness: 2, leadership: 2 } },
          { text: "Gather input from trusted friends and family", traits: { collaboration: 3, empathy: 2, humility: 2 } },
          { text: "Research thoroughly and weigh all options", traits: { wisdom: 3, caution: 2, strategy: 3 } },
          { text: "Go with what feels right emotionally", traits: { intuition: 3, empathy: 2, sensitivity: 2 } }
        ],
        order: 6
      },
      {
        ...
        options: [
          { text: "Confront the issue directly and assertively", traits: { confidence: 3, leadership: 2, directness: 3 } },
          { text: "Try to find a compromise that works for everyone", traits: { empathy: 3, collaboration: 2, harmony: 2 } },
          { text: "Step back and analyze the situation objectively", traits: { wisdom: 3, caution: 2, objectivity: 2 } },
          { text: "Avoid confrontation when possible", traits: { harmony: 2, introversion: 2, sensitivity: 2 } }
        ],
        order: 7
      },
      {
        ...
        options: [
          { text: "Achieving greatness and being recognized", traits: { ambition: 3, confidence: 2, leadership: 2 } },
          { text: "Having meaningful connections with others", traits: { empathy: 3, social: 2, love: 3 } },
          { text: "Continuously learning and growing", traits: { curiosity: 3, wisdom: 2, growth: 3 } },
          { text: "Finding peace and personal fulfillment", traits: { harmony: 3, introversion: 2, contentment: 2 } }
        ],
        order: 8
      },
      {
        ...
        options: [
          { text: "Direct, clear, and commanding", traits: { leadership: 3, confidence: 2, directness: 3 } },
          { text: "Warm, expressive, and engaging", traits: { social: 3, empathy: 2, charisma: 2 } },
          { text: "Thoughtful, precise, and informative", traits: { wisdom: 3, communication: 2, clarity: 2 } },
          { text: "Gentle, considerate, and diplomatic", traits: { empathy: 3, harmony: 2, sensitivity: 2 } }
        ],
        order: 9
      },
      {
        ...
        options: [
          { text: "Dynamic and challenging with opportunities to lead", traits: { leadership: 3, ambition: 2, energy: 2 } },
          { text: "Social and collaborative with lots of interaction", traits: { social: 3, collaboration: 2, energy: 2 } },
          { text: "Quiet and organized where you can focus deeply", traits: { introversion: 3, focus: 2, order: 2 } },
          { text: "Peaceful and natural where you can be yourself", traits: { harmony: 3, nature: 2, authenticity: 2 } }
        ],
        order: 10
      }
    ];
    ...
    const animalsData: Omit<Animal, 'id'>[] = [
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1546182990-dffeafbe841d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400"
      },
      {
        name: "Dolphin",
        ...
        imageUrl: "https://images.unsplash.com/photo-1544551763-46a013bb70d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400"
      },
      {
        name: "Owl",
      ...
      },
      {
        ...
        traits: { intelligence: 92, creativity: 90, adaptability: 95, strategy: 88 },
        imageUrl: "https://images.unsplash.com/photo-1474511320723-9a56873867b5?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400"
      },
      {
        name: "Eagle",
        ...
        traits: { ambition: 95, independence: 90, vision: 92, determination: 88 },
        imageUrl: "https://images.unsplash.com/photo-1611273426858-450d8e3c9fce?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400"
      },
      {
        name: "Panda",
        ...
        imageUrl: "https://images.unsplash.com/photo-1564349683136-77e08dba1ef7?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400"
      },
      {
        name: "Cat",
        ...
        traits: { independence: 95, intuition: 90, selectivity: 88, confidence: 85 },
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1605792657660-596af9009e82?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=400"
      }
    ];
